    ...
    python:
        ...
        try:
            ...
            if callable(_bla):
                ...
                rei_before = _safe_int(getattr(S, "turn_def_rei_before", getattr(S, "player_reiatsu", 0)), 0)
                rei_after = _safe_int(getattr(S, "turn_def_rei_after", getattr(S, "player_reiatsu", 0)), 0)
                ene_before = _safe_int(getattr(S, "turn_def_ene_before", getattr(S, "player_energy", 0)), 0)
                ene_after = _safe_int(getattr(S, "turn_def_ene_after", getattr(S, "player_energy", 0)), 0)
                ...
                rei_tech_sum = max(0, _safe_int(getattr(S, "turn_def_rei_tech_sum", rei_turn_use), rei_turn_use))
                ene_tech_sum = max(0, _safe_int(getattr(S, "turn_def_ene_tech_sum", ene_turn_use), ene_turn_use))
