            ...
            vbox:
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        bar value StaticValue(max(0, _prei_show), max(1, _pmax_rei)) xmaximum _bar_w left_bar "#4EA3FF" right_bar "#1D2C4A"
                        text ("Energía %s / %s" % (_pene_show, _pmax_ene)) size 14
                        bar value StaticValue(max(0, _pene_show), max(1, _pmax_ene)) xmaximum _bar_w left_bar "#FF9E4E" right_bar "#4A2C1D"
            ...
            vbox:
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        bar value StaticValue(max(0, _erei_show), max(1, _emax_rei)) xmaximum _bar_w left_bar "#4EA3FF" right_bar "#1D2C4A" xalign 1.0
                        text ("Energía %s / %s" % (_eene_show, _emax_ene)) size 14 xalign 1.0
                        bar value StaticValue(max(0, _eene_show), max(1, _emax_ene)) xmaximum _bar_w left_bar "#FF9E4E" right_bar "#4A2C1D" xalign 1.0
