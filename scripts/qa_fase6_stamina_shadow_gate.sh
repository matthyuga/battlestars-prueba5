...
rg -n "precombat_resource_perks_v2|resource_perks_v2|shadow_target_mode|Perks de Recursos \(v2\)|precombat_legacy_specials_fallback_enabled" game/04I_PRECOMBAT_LOADOUT_SCREENV1.rpy >/dev/null
...
rg -n "resource_perks_v2|perks_v2|shadow_target_mode|applied_to_enemy" game/04b_battle_startV2.rpy >/dev/null
