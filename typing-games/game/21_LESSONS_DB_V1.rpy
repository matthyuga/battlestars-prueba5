        ...
        "lesson_1": {
            ...
            "sublessons": {
                ...
                "1_4b_typing_lab": {
                    ...
                    "state": "real",
                    "scene_type": "typing_lab_route",
                    "objective": "Entrar al Typing Lab desde Sakura para práctica de letras.",
                    "steps": [
                        {
                            "title": "Ruta a Typing Lab",
                            "points": [
                                "Esta sublección abre Typing Lab en modo letras.",
                                "Sirve para validar integración Sakura → Typing Lab.",
                                "Luego se personalizará la UI paso a paso.",
                            ],
                            "teacher_line": "Primero validamos ruta estable; luego iteramos visuales y reglas.",
                        },
                    ],
                },
                "1_6_words_exercise": {
