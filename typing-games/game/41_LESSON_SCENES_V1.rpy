...
init python:
    ...
    def tl_warmup_summary_lines(teacher_id="haru"):
        ...
        if tid == "misaki":
            return [
                "¡Excelente trabajo! Pudiste completar tu primer ejercicio; aunque es lo básico de la mecanografía, ya estás entendiendo la lógica: cada dedo está asignado a una tecla.",
                "Con tiempo y práctica terminarás dominando el teclado... o prendiéndolo fuego...",
                "Continuemos aprendiendo.",
            ]
        return [
            "Muy bien, has completado tu primer ejercicio de tipeo.",
            "Recuerda que cada dedo maneja una tecla; cuando te acostumbres a la práctica, tipearás como una auténtica máquina...",
